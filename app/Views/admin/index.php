                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/IT.png"
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/DE.png"
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/US.png"
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/CO.png"
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/RS.png"
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/FR.png"
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>vendor/flag-icons/24/RU.png"
                            ...
                            <ul class="sa-timeline__list">
                                <li class="sa-timeline__item">
                                    ...
                                    <div class="sa-timeline__item-content">Phasellus id mattis nulla. Mauris
                                        ...
                                        commodo scelerisque lacus, at porttitor dui iaculis id. <a href="#">Curabitur
                                            imperdiet ultrices fermentum.</a></div>
                                </li>
                                <li class="sa-timeline__item">
                    ...
                    <ul class="list-group list-group-flush">
                            ...
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-1-40x40.jpg"
                                            width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Wiper
                                            Blades Brandix WL2</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html"
                                                class="text-reset">Ryan Ford</a>
                                        </div>
                                    </div>
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-7-40x40.jpg"
                                            width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Electric
                                            Planer Brandix KL370090G
                                            300 Watts</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html"
                                                class="text-reset">Adam Taylor</a>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-auto">
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-10-40x40.jpg"
                                            width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Water
                                            Tap</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html"
                                                class="text-reset">Jessica
                                                Moore</a></div>
                                    </div>
                                    <div class="col-12 col-sm-auto">
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-5-40x40.jpg"
                                            width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Brandix
                                            Router Power Tool
                                            2017ERXPK</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html"
                                                class="text-reset">Helena
                                                Garcia</a></div>
                                    </div>
                                    <div class="col-12 col-sm-auto">
                                        <div class="sa-rating ms-sm-3 my-2 my-sm-0" style="--sa-rating--value:0.6">
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-2-40x40.jpg"
                                            width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                    <div class="col"><a href="app-product.html" class="text-reset fs-exact-14">Undefined
                                            Tool IRadix DPS3000SY
                                            2700 Watts</a>
                                        <div class="text-muted fs-exact-13">Reviewed by <a href="app-customer.html"
                                                class="text-reset">Ryan Ford</a>
                                        </div>
                        ...
                        <li class="list-group-item py-2">
                            <div class="d-flex align-items-center py-3">
                                <a href="app-product.html" class="me-4">
                                    <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                        <img src="<?php echo ASSETS_URL_ROOT . '/admin_assets/' ?>images/products/product-16-40x40.jpg"
                                            width="40" height="40" alt="" />
                                    </div>
                                </a>
                                <div class="d-flex align-items-center flex-grow-1 flex-wrap">
