        ...
        <div class="container container--max--xl">
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-auto d-flex"><button class="btn btn-secondary me-3">Delete</b><button onclick="submitForm()" class="btn btn-primary">Create</button></div>
                </div>
            </div>
            <div class="sa-entity-layout" data-sa-container-query="{&quot;920&quot;:&quot;sa-entity-layout--size--md&quot;,&quot;1100&quot;:&quot;sa-entity-layout--size--lg&quot;}">
                <?php getFlash('error') ?>
                <form id="cate_form" action="<?php url('admin/couponadd') ?>" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="sa-entity-layout__main">
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4"><label for="form-coupon/code" class="form-label">Code</label><input type="text" name="code" class="form-control" id="form-coupon/code" placeholder="QWERTY12" />
                                    </div>

                                    <div class="mb-4"><label for="form-coupon/value" class="form-label">Discount
                                            value</label><input name="discount" type="text" class="form-control" id="form-coupon/value" value="100000" /></div>
                                    <div class="mb-4"><label for="form-coupon/limit" class="form-label">Usage
                                            limit</label><input name="usage_limit" type="text" class="form-control" id="form-coupon/limit" value="100" /></div>
