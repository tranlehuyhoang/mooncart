...
require_once __DIR__ . '/components/navbar_new.php';
...
<body>
                ...
                <div class="swiper product-thumb">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="shop-card shop-overlay shop-height-100">
                                <div class="dz-media">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/public/upload/' ?><?php echo isset($latestProduct['product_image']) && $latestProduct['product_image'] !== '' ? $latestProduct['product_image'] : 'empty-img.png'; ?>"
                                        alt="/">
                                    <div class="shop-meta">
                                ...
                                <div class="dz-content">
                                    <h5 class="title"><a
                                            href="<?php echo url('products/detail/' . $latestProduct['id']); ?>"><?php echo $latestProduct['name']; ?></a>
                                    </h5>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 d-lg-block d-none">
                <div class="swiper product-gallery">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="smart-product-details">
                                <div class="dz-media">
                                    <img style="height: 100% !important; object-fit: contain !important;"
                                        src="<?php echo ASSETS_URL_ROOT . '/public/upload/' ?><?php echo isset($slide['product_image']) && $slide['product_image'] !== '' ? $slide['product_image'] : 'empty-img.png'; ?>"
                                        alt="/">
                                </div>
                                <div class="dz-content">
                                    <h4 class="title"> <?php echo $slide['name']; ?></h4>
                                    <p>S <?php echo $slide['description']; ?></p>
                                    <div class="extra-info-box">
                                        <div class="swiper-meta-items">
                                            <div class="meta-content">
                                                <span class="price-name">Price</span>
                                                <span class="price-num">
                                                    <?php Format::currency($slide['promotion_price']) ?> </span>
                                            </div>

                                        </div>
                                        <div class="content-btn">
                                            <a class="btn btn-light btn-md me-3" href="shop-cart.html">ADD TO
                                                CART</a>
                                            <a class="btn btn-outline-light btn-md"
                                                href="<?php echo url('products/detail/' . $slide['id']); ?>">VIEW
                                                DETAILS</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="footer-menu">
        <ul>
            <li>
                <h6>Smart Home Products :</h6>
            </li>
            <li><a href="javascript:void();">Thermostats</a></li>
            <li><a href="javascript:void();">Lighting</a></li>
            <li><a href="javascript:void();">Security Systems</a></li>
            <li><a href="javascript:void();">Locks</a></li>
            <li><a href="javascript:void();">Home Assistants</a></li>
            <li><a href="javascript:void();">Water Monitors</a></li>
        </ul>
    </div>
