                                                ...
                                                <div class="swiper-content">
                                                    <div class="content-info">
                                                        ...
                                                        <div class="content-btn" data-swiper-parallax="-60">
                                                            ...
                                                            <a class="btn btn-outline-secondary btnhover20" href="<?php echo url('products/detail/' . $slide['id']); ?>">VIEW
                                                                DETAILS</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="banner-media">
                                                    <div class="img-preview" data-swiper-parallax="-100">
                                                        <img style="height: 100%; width: 100% !important;" src="<?php echo ASSETS_URL_ROOT . '/public/upload/' ?><?php echo isset($slide['product_image']) && $slide['product_image'] !== '' ? $slide['product_image'] : 'empty-img.png'; ?>" alt="banner-media">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    <div class="row product-style1">
                        <div class="col-lg-6 p-b30 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-box style-1" style="background-image: url('<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/shop/product1.png');">
                        ...
                        <div class="col-lg-6">
                            <div class="row product-style-1">
                                <div class="col-lg-12 m-b30 wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="product-box style-2" style="background-image: url('<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/shop/product2.png');">
                                        <div class="product-content">
                                            <div class="main-content">
                                ...
                                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="product-box style-3" style="background-image: url('<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/shop/product3.png');">
                                        <div class="product-content">
                                            <div class="main-content">
            ...
            <section class="content-inner-1 bg-light">
                <div class="container">
                    ...
                    <div class="site-filters clearfix d-flex align-items-center wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <a href="<?php url('products/detail/123') ?>" class="product-link text-secondary font-14 d-flex align-items-center gap-1 text-nowrap">See
                            all products
                    ...
                    <div class="clearfix">
                        <ul id="masonry" class="row g-xl-4 g-3">
                            <?php foreach ($data['latestProducts'] as $latestProduct) : ?>
...
"
                                        ...
                                        <div class="dz-content">
                                            <h5 class="title"><a href="<?php echo url('products/detail/' . $latestProduct['id']); ?>"><?php echo $latestProduct['name']; ?></a>
                                            </h5>
                                        ...
                                        <div class="product-tag">
                                            <span class="badge badge-secondary">-
                                                <?php
                                                $discountPercentage = ($latestProduct['price'] - $latestProduct['promotion_price']) / ($latestProduct['price']) * 100;
                                                echo number_format($discountPercentage, 0) . '%';
                                                ?>
                                            </span>
                                            <?php echo (isset($latestProduct['feature']) && $latestProduct['feature'] == 1) ? '<span class="badge badge-primary">Featured</span>' : ''; ?>
                ...
                <div class="container-fluid px-0">
                    <div class="row product-style2 g-0">
                        <div class="col-lg-6 col-md-6 p-b30 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-box style-4" style="background-image: url('<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/shop/large/product1.png');">
                                <div class="product-content">
                                    <div class="main-content">
                                    ...
                                    <a href="<?php url('products/detail/123') ?>" class="btn btn-outline-secondary">Shop
                                        Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 p-t30 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-box style-4" style="background-image: url('<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/shop/large/product2.png');">
                                <div class="product-content">
                                    <div class="main-content">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="shop-card wow fadeInUp" data-wow-delay="0.3s">
                                        ...
                                        <div class="dz-content">
                                            <h5 class="title"><a href="<?php url('products/detail/123') ?>">Paper
                                                    Bags</a></h5>
                                            <ul class="star-rating">
                                                <li>
                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- About Start-->
            <section class="content-inner overlay-white-dark overflow-hidden" style="background-image: url('<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/background/bg1.jpg'); background-repeat: no-repeat; background-size: cover;">
                <div class="container">
                    <div class="row about-style1 align-items-center">
                        <div class="col-lg-6 m-b30">
                            <div class="position-relative">
                                <div class="about-thumb wow fadeInUp" data-wow-delay="0.1s">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/girl.png" alt="">
                                </div>
                                <div class="our-customer wow fadeInUp" data-wow-delay="0.2s">
                                    <h6>Our Satisfied User</h6>
                                    <ul>
                                        <li class="customer-image">
                                            <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/testimonial/pic1.png" alt="">
                                        </li>
                                        <li class="customer-image">
                                            <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/testimonial/pic2.png" alt="">
                                        </li>
                                            ...
                                            <div class="about-content">
                                                ...
                                                <div class="about-bx-detail">
                                                    <div class="about-bx-pic radius">
                                                        <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/testimonial/testimonial4.jpg" alt="">
                                                    </div>
                                                    <div>
            ...
            <section class="content-inner overlay-white-middle">
                <div class="container">
                    <div class="section-head style-2 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <a href="blog-dark-2-column-sidebar.html" class="text-secondary font-14 d-flex align-items-center gap-1 text-nowrap">See all Post
                            <i class="icon feather icon-chevron-right font-18"></i>
                        </a>
                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 order-lg-1 order-2 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="dz-card style-1 d-lg-block d-md-flex d-sm-flex d-block">
                                <div class="dz-media w-100">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/blog/blog1.png" alt="">
                                </div>
                                <div class="dz-info">
                                    <div class="dz-meta">
                                        <ul>
                                    ...
                                    <h3 class="dz-title mb-md-3 mb-sm-5 m-b10">
                                        <a href="blog-dark-2-column.html">Uncovering The Benefits of Wooden Based
                                            Furniture</a>
                                    </h3>
                                    <a href="blog-dark-2-column.html" class="font-14 mt-auto read-btn">Read More
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                                    <div class="dz-card blog-half style-5 m-b30">
                                        <div class="dz-media">
                                            <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/blog/blog2.png" alt="">
                                        </div>
                                        <div class="dz-info">
                                            <div class="dz-meta">
                                                <ul>
                                            ...
                                            <h4 class="dz-title">
                                                <a href="blog-dark-half-image.html">Explore The Benefits of Wooden
                                                    Utensils In DailyLife</a>
                                            </h4>
                                            <a href="blog-dark-half-image.html" class="font-14 read-btn">Read More
                                                <i class="icon feather icon-chevron-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="dz-card blog-half style-5 m-b30">
                                        <div class="dz-media">
                                            <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/blog/blog3.png" alt="">
                                        </div>
                                        <div class="dz-info">
                                            <div class="dz-meta">
                                                <ul>
                                            ...
                                            <h4 class="dz-title">
                                                <a href="blog-dark-half-image.html">With Wooden Comb Makes Your Hairs
                ...
                <div class="container-fluid px-0">
                    <div class="row gx-0">
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.1s">
                            <div class="insta-post dz-media dz-img-effect rotate">
                                <a href="javascript:void(0);">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/1.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="insta-post dz-media dz-img-effect rotate">
                                <a href="javascript:void(0);">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/2.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.3s">
                            <div class="insta-post dz-media dz-img-effect rotate">
                                <a href="javascript:void(0);">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/3.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.4s">
                            <div class="insta-post dz-media dz-img-effect rotate">
                                <a href="javascript:void(0);">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/4.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.5s">
                            <div class="insta-post dz-media dz-img-effect rotate">
                                <a href="javascript:void(0);">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/5.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-4 wow fadeIn" data-wow-delay="0.6s">
                            <div class="insta-post dz-media dz-img-effect rotate">
                                <a href="javascript:void(0);">
                                    <img src="<?php echo ASSETS_URL_ROOT . '/client_assets/' ?>images/feature/6.png" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
